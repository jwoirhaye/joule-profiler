use crate::{CliArgs, ProfilerCommand};
use joule_profiler_core::config::{Command, Config, ListSensorsConfig, ProfileConfig};
use joule_profiler_core::output::output_format;
